...
import { syncPunjabData, getLatestPunjab, getDistrictRecords, getAllPunjab } from "../controllers/mgnregaController.js";
...
router.get("/all", getAllPunjab); // new endpoint for all Punjab data
